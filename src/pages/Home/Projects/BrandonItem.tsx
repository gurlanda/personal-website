...
const Video: React.FC<{}> = () => {
  return (
    <div className="relative h-full w-full">
      ...
      <div className="absolute max-ms:bottom-[8vh] ms:bottom-0 left-1/2 [transform:translate(-50%)] pb-10 lg:pb-20 flex flex-col justify-end items-center font-ibm-plex-serif text-white transition-opacity [text-shadow:0_0_20px_hsl(0,0%,0%,0.75)]">
        <h1 className="text-4xl lg:text-5xl 2xl:text-6xl leading-[2.5rem]">
          Brandon
        </h1>
        <h2 className="text-6xl lg:text-7xl 2xl:text-8xl leading-[2.5rem]">
          Victoriano
        </h2>
      </div>
    </div>
